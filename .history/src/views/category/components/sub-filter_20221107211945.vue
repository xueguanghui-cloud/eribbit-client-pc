...
import type {
  ICategoryFilter,
  ISaleProperties,
} from "@/types/category/category-filter";
import type { IFilterParams } from "@/types/category/params";
...
const getFilterParams = () => {
  ...
  const paramsObj: IFilterParams = { brandId: "", attrs: null };
  ...
  if (paramsObj.attrs.length === 0) paramsObj.attrs = null;
  return paramsObj;
};
...
// 记录当前的选择的销售属性
const changeProps = (item: ISaleProperties, propId: string) => {
