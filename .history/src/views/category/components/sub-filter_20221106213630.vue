...
// 记录当前选择的品牌
const changeBrand = (bradnId: string) => {
  filterData.value!.selectedBrand = bradnId;
};

// 记录当前选择的属性
const changeProps = (prop: IProperties, propId: string) => {
...
<template>
  ...
  <div class="sub-filter" v-if="filterData && !filterLoading">
    <div class="item">
      ...
      <div class="body">
        <a
          @click="changeBrand(item, item.id)"
          href="javascript:;"
    ...
    <div class="item" v-for="item in filterData.saleProperties" :key="item.id">
      ...
      <div class="body">
        <a
          @click="changeProps(prop, prop.id)"
          href="javascript:;"
