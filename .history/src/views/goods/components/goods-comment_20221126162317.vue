...
import type { ICommentInfo, IRequestParams } from "@/types/goods/good-comment";
...
<template>
  <div class="goods-comment" v-if="commentInfo">
    ...
    <div class="sort">
      <span>排序：</span>
      <a
        @click="requestParams.sortField = null"
      ...
      <a
        @click="requestParams.sortField = 'createTime'"
      ...
      <a
        @click="requestParams.sortField = 'praiseCount'"
