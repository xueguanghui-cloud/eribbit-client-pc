...
findCommentInfoByGoods(route.params.id as string).then((res: any) => {
  ...
  commentInfo.value?.tags.unshift({ tagCount: 100, title: "有图" });
  commentInfo.value?.tags.unshift({ tagCount: 100, title: "全部评价" });
  ...
  <div class="goods-comment" v-if="commentInfo">
    ...
    <div class="head">
      ...
      <div class="tags">
        ...
        <div class="dd" v-for="tag in commentInfo?.tags" :key="tag.title">
