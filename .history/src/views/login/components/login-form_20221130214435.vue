...
const login = async (validate: Function) => {
  /* const valid = await validate();
  console.log(valid); */
  formRef.value.validate().then((result: ant) => {
    console.log(result);
  });
};
</script>
...
<template>
  <div class="account-box">
    ...
    >
      ...
      <div class="form-item">
        <div class="agree">
          <Field name="isAgree" as="xgh-checkbox" v-model="form.isAgree">
      ...
      <a href="javascript:;" class="btn" @click="login(validate)">登录</a>
    </Form>
    <div class="action">
      <img
