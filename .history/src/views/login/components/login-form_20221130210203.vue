...
import { Form, Field, useValidateForm, validate } from "vee-validate";
...
validate(form, internalSchema).then((res) => {
  console.log(res);
});
</script>
...
<template>
  <div class="account-box">
    ...
    >
      ...
      <a href="javascript:;" class="btn" @click="validate(errors)">登录</a>
    </Form>
    <div class="action">
      <img
