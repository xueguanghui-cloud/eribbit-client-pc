...
<template>
  <div class="account-box">
    ...
    >
        ...
        <div class="form-item">
          <div class="input">
            ...
            <Field
              ...
              :class="{ error: validate.account }"
            ></Field>
            <div class="error" v-if="validate.account">
              <i class="iconfont icon-warning" />{{ validate.account }}
            </div>
          </div>
        </div>
        <div class="form-item">
      ...
      <a href="javascript:;" class="btn" @click="errors">登录</a>
    </Form>
    <div class="action">
      <img
