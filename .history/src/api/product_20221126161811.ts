...
import type { IRequestParams } from "@/views/goods/components/goods-comment.vue"
...
export const findCommentInfoByGoods = (id: string) => {
  ...
  return get(`https://mock.boxuegu.com/mock/1175/goods/${id}/evaluate`);
};
 ...
 */
export const findCommentListByGoods = (id: string, params: ) => {
  // return get(`/goods/${id}/evaluate`);
  return get(
